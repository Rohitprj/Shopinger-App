...
//           const response = await axiosInstance.get('web/get-products-by-sub-sub-category/wall-art');
//           console.log('Categories data all:', response.data);
...
const ProductCard = ({ item }) => {
  ...
  return (
    <View style={styles.productCard}>
      ...
      <View style={styles.ratingContainer}>
        {/* You might want to replace this with an actual star icon if available */}
        {rating !== 'N/A' && (
          <Image
            // Assuming you have a star icon in your assets or can use a placeholder
            // source={require('../../assets/star_icon.png')} // Replace with your actual star icon path
            style={styles.starIcon}
          />
        )}
...
export default function ProductAllData() {
  ...
  const fetchProductsData = async () => {
    try {
      ...
      // Fetching products by sub-sub-category 'wall-art' as per your commented code
      const response = await axiosInstance.get('/web/get-products-by-sub-sub-category/wall-art');
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.header}>
        {/* Back Arrow (commented out as in original) */}
        {/* <TouchableOpacity>
          <Image
            // source={require('./assets/back_arrow.png')} // Replace with your back arrow icon
            style={styles.backArrowIcon}
        ...
        />
        <View style={styles.headerRight}>
          {/* Bell Icon (commented out as in original) */}
          {/* <TouchableOpacity style={styles.headerIconContainer}>
            <Image
              // source={require('./assets/bell_icon.png')} // Replace with your bell icon
              style={styles.headerIcon}
      ...
      {loadingProducts ? (
        ...
        //   ListFooterComponent={() => ( // Add the bottom banner as a footer
        //     <Image
        //       source={require('../../assets/products/hotSummerSale.png')} // Using an existing banner from your App.js, replace if you have a specific bottom promo banner
        //       style={styles.bottomPromoBanner}
        //     />
        //   )}
        />
      ...
      {/* Bottom tabs will be rendered by your existing App.js if this component is part of a larger screen */}
    </SafeAreaView>
  );
}
